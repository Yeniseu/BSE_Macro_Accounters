...
# Select Ireland
inp_path    <- "02_Input/IE_national_accounts.xlsx"
...
inp_path<- "02_Input/IE_intangible_analytical.xlsx"
...
inp_path<- "02_Input/IE_capital_accounts.xlsx"
...
png("03_Output/Exercise b/b_Ireland_EMP_TOT.png", width = 800, height = 600, res = 120) # opening png 

dt[, y_pw  := VA_Q / EMP]
plot(dt[nace == "TOT", year], dt[nace == "TOT", y_pw], type = "l", lwd = 2,
     main = paste0("Ireland - Output per Efficient Worker (TOTAL)"),
     xlab = "", ylab = "")
...
png("03_Output/Exercise b/b_Ireland_H_EMP_TOT.png", width = 800, height = 600, res = 120) # opening png 
...
png("03_Output/Exercise b/b_Ireland_H_EMPE_TOT.png", width = 800, height = 600, res = 120) # opening png
...
# Using number of employees
png("03_Output/Exercise b/b_Ireland_EMP_MARKET.png", width = 800, height = 600, res = 120) # opening png 

dt[, y_pw  := VA_Q / EMP]
plot(dt[nace == "MARKT", year], dt[nace == "MARKT", y_pw], type = "l", lwd = 2,
     main = paste0("Ireland - Output per Efficient Worker (MARKET)"),
     xlab = "", ylab = "")
mtext("Note: Output per efficient worker calculated using number of employees.", side = 1, line = 4, cex = 0.8)
...
png("03_Output/Exercise b/b_Ireland_H_EMP_MARKET.png", width = 800, height = 600, res = 120) # opening png 
...
png("03_Output/Exercise b/b_Ireland_H_EMPE_MARKET.png", width = 800, height = 600, res = 120) # opening png
...
write_xlsx(growth_tot, path = "03_Output/Exercise c/c_Ireland.xlsx")

# Plot ;)

growth_tot <- growth_tot %>%filter(Year > 1995)
png("03_Output/Exercise c/c_Ireland.png", width = 800, height = 600, res = 120) # opening png
